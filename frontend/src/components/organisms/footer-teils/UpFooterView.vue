    ...
    <div class="sm:flex flex-wrap">
      ...
      <div class="mt-12 sm:w-1/2 lg:w-2/5 lg:mt-0 lg:pl-12">
        ...
        <div class="flex-col mx-auto md:flex-row justify-between space-x-4">
          ...
          />
          <img
            src="https://frankfurt.de/-/media/frankfurtde/service-und-rathaus/verwaltung/aemter-und-institutionen/gruenflaechenamt/image/amt67_logo_full.ashx?la=de-de67af2ca5ea4d4935b6eb7badf4b7aeb1&mw=1000&hash=0F744066C4D72D1BB24BD60601CD4605"
